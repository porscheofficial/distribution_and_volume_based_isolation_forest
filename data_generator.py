...
class DataGenerator:
    ...
    # remove randomness ## IMPORTED FROM UTILS
    ...
    def generator(
        ...
        self.set_seed(self.seed)  # self.utils.set_seed(self.seed)
        ...
        # show the statistic
        self.data_description(self.seed)  # self.utils.data_description(self.seed)
